  ...
  <div class="row">
    ...
    <div cl<!DOCTYPE html>
        ...
        <div class="row">
              ...
              <ul>
                ...
                <li class="button">
                  ...
                  <ul class="feat-show">
                    ...
                    <li>
                      <a href="../jdwl_mapel/jadwalmapel.php"><i class="bi bi-book-half"></i>Jadwal Mata Pelajaran</a>
                    </li>
                  </ul>
                </li>
                <li class="button">
          ...
          <div class="col-md-9">
            <div class="container">
              <nav class="navbar">
                <div id="indikator">
                  <a href="tampilpresensikls4.php" class="bi bi-arrow-left"></a>
                  <h5 style="padding-right: 30px">
                    Halaman Tambah presensi Siswa Kelas 4
                  </h5>
                </div>
                <ul>
                  <li>Admin |</li>
              ...
              <div class="box">
                <div class="container">
                  <form action="../presensi/tampilpresensikls4.php">
                    ...
                    <input type="text" id="nama_siswa" name="nama_siswa" placeholder="Masukkan nama siswa" /><br /><br />
      ...
      <div class="container">
        <nav class="navbar">
          <div id="indikator">
            <a href="tampilpresensikls3B.php" class="bi bi-arrow-left"></a>
            <h5 style="padding-right: 30px">
              Halaman Tambah presensi Siswa Kelas 3B
            </h5>
          </div>
          <ul>
            <li>Admin |</li>
        ...
        <div class="box">
          <div class="container">
            <form action="../presensi/tampilpresensikls3B.php">
              <label for="nisn">NISN:</label><br />
              <input type="text" id="nisn" name="nisn" placeholder="Masukkan NISN" /><br />
              <label for="nisn">ID Siswa:</label><br />
              <input type="text" id="id_siswa" name="id_siswa" placeholder="Masukkan id siswa" /><br />
