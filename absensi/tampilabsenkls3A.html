    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="container">
          <nav class="navbar">
            <div id="indikator">
              <a href="absensikls3.html" class="bi bi-arrow-left"></a>
              <h5>Halaman Tampil Absensi Siswa Kelas 3A</h5>
            </div>
            <ul>
              <li>Admin |</li>
          ...
          <div class="box">
            <div class="container">
              <div class="tambah">
                <a href="../absensi/tambahabsenkls3A.html"
