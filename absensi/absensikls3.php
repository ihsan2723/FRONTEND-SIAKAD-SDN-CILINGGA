  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="container">
        <nav class="navbar">
          <div id="indikator">
            <a href="absensi.php" class="bi bi-arrow-left"></a>
            ...
            <div class="tabel">
              <table>
                ...
                <tr>
                  ...
                  <td>A</td>
                  <td>
                    <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilabsenkls3A.php"></a>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
                  ...
                  <td>B</td>
                  <td>
                    <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilabsenkls3B.php"></a>
                  </td>
                </tr>
                <tr>
                  <td>3.</td>
