    ...
    <div class="row">
      ...
      <div cl<!DOCTYPE html>
              ...
              <div class="col-md-3">
                <div class="sidebar">
                  ...
                  <ul>
                    ...
                    <li class="button">
                      <i class="bi bi-house-add-fill"></i>
                      <a href="../profil_sekolah/profilsekolah.html"
                        >Profil Sekolah</a
                      >
                    </li>
                    <li class="button">
                    ...
                    <li class="button">
                      <i class="fa-solid fa-clipboard-user"></i>
                      <a href="absensi.html" style="margin-left: 8px"
                        >Absensi</a
                      >
                    </li>
                    <li class="button">
              ...
              <div class="col-md-9">
                <div class="container">
                  <nav class="navbar">
                    <div id="indikator">
                      <a
                        href="tampilabsenkls4.html"
                        class="bi bi-arrow-left"
                      ></a>
                      <h5 style="padding-right: 30px">
                        Halaman Tambah Absensi Siswa Kelas 4
                      </h5>
                    </div>
                    <ul>
                      <li>Admin |</li>
                  ...
                  <div class="box">
                    <div class="container">
                      <form action="../absensi/tampilabsenkls4.html">
        ...
        <div class="container">
          <nav class="navbar">
            <div id="indikator">
              <a href="tampilabsenkls3B.html" class="bi bi-arrow-left"></a>
              <h5 style="padding-right: 30px">
                Halaman Tambah Absensi Siswa Kelas 3B
              </h5>
            </div>
            <ul>
              <li>Admin |</li>
          ...
          <div class="box">
            <div class="container">
              <form action="../absensi/tampilabsenkls3B.html">
                <label for="nisn">NISN:</label><br />
                <input
                  type="text"
                  id="nisn"
