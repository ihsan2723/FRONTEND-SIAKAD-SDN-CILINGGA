  ...
  <div class="row">
    ...
    <div cl<!DOCTYPE html>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="container">
              <nav class="navbar">
                <div id="indikator">
                  <a href="tampilabsenkls4.php" class="bi bi-arrow-left"></a>
              ...
              <div class="box">
                <div class="container">
                  <form action="../absensi/tampilabsenkls4.php">
      ...
      <div class="container">
        <nav class="navbar">
          <div id="indikator">
            <a href="tampilabsenkls3B.php" class="bi bi-arrow-left"></a>
            <h5 style="padding-right: 30px">
        ...
        <div class="box">
          <div class="container">
            <form action="../absensi/tampilabsenkls3B.php">
              <label for="nisn">NISN:</label><br />
              <input type="text" id="nisn" name="nisn" placeholder="Masukkan NISN" /><br />
              <label for="nisn">ID Siswa:</label><br />
              <input type="text" id="id_siswa" name="id_siswa" placeholder="Masukkan id siswa" /><br />
