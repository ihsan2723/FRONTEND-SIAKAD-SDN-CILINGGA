  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="container">
        <nav class="navbar">
          <div id="indikator">
            <a href="mapelkls3.php" class="bi bi-arrow-left"></a>
        ...
        <div class="box">
          <div class="container">
            <div class="tambah">
              <a href="../mapel/tambahmapelkls3B.php">
            ...
            <div class="tabel">
              <table>
                <tr>
                  <th>No</th>
                  <th>Kode Mata Mata Pelajaran</th>
                  <th>Nama Mapel</th>
                  <th>Action</th>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <a id="edit" class="bi bi-pencil-fill" href="editmapelkls3B.php"></a>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
