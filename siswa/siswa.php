    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="container">
                ...
                <hr />
                <div class="box">
                    <a href="../siswa/siswakls1.php">
                        <div class="items">
                            <h3>Siswa Kelas 1</h3>
                        </div>
                    </a>
                    <a href="../siswa/siswakls2.php">
                        <div class="items">
                            <h3>Siswa Kelas 2</h3>
                        </div>
                    </a>
                    <a href="../siswa/siswakls3.php">
                        <div class="items">
                            <h3>Siswa Kelas 3</h3>
                        </div>
                    </a>
                    <a href="../siswa/siswakls4.php">
                        <div class="items">
                            <h3>Siswa Kelas 4</h3>
                        </div>
                    </a>
                    <a href="../siswa/siswakls5.php">
                        <div class="items">
                            <h3>Siswa Kelas 5</h3>
                        </div>
                    </a>
                    <a href="../siswa/siswakls6.php">
                        <div class="items">
                            <h3>Siswa Kelas 6</h3>
                        </div>
                    </a>
