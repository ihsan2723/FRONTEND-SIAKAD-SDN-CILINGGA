                        ...
                        <div class="tabel">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>A</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilnilai3A.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    ...
                                    <td>B</td>
                                    <td>
                                        <a id="view" class="bi bi-eye-fill" style="color: #fefae0" href="tampilnilai3B.php"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3.</td>
