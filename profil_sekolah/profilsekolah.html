    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="container">
          ...
          <hr />
          <div class="box">
            <a href="../profil_sekolah/profilsekolah1.html">
              <div
                class="items"
                style="background: rgba(0, 0, 0, 0.55) url(../gambar/index.JPG)"
              >
                <h3>Profil Sekolah</h3>
              </div>
            </a>
            <a href="../profil_sekolah/informasisekolah.html">
              <div
                class="items"
                style="
            ...
            <a href="../profil_sekolah/alamatsekolah.html">
              <div
                class="items"
                style="
            ...
            <a href="../profil_sekolah/strukurorgsekolah.html">
              <div
                class="items"
                style="
